...
EGIT_REPO_URI="git://github.com/yi-editor/yi.git"

LICENSE="GPL-2"
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="eventlog pango profiling +testing +vty"
...
RDEPEND=">=dev-haskell/binary-0.5:=[profile?]
	...
	>=dev-lang/ghc-7.4.1:=
	pango? ( >=dev-haskell/glib-0.13:=[profile?] <dev-haskell/glib-0.14:=[profile?]
