...
DESCRIPTION="mpv-specific fork of FFmpeg"
HOMEPAGE="https://github.com/mpv-player/ffmpeg-mpv"
FFMPEG_REVISION="${PV#*_p}"

SLOT="mpv/${FFMPEG_SUBSLOT}"
LICENSE="
	!gpl? ( LGPL-2.1 )
	gpl? ( GPL-2 )
	amr? (
...
IUSE="
	alsa chromium +encode jack oss pic static-libs test v4l
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}
"
...
MULTILIB_WRAPPED_HEADERS=(
	/usr/include/ffmpeg-mpv/libavutil/avconfig.h
)
...
multilib_src_configure() {
	...
	myconf+=(
		...
		--build-suffix=mpv
		--progs-suffix=mpv
		--incdir="${EPREFIX}/usr/include/ffmpeg-mpv"
        --datadir="${EPREFIX}/usr/share/ffmpeg-mpv"
	)
