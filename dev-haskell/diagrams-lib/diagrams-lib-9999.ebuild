...
EGIT_REPO_URI="git://github.com/diagrams/diagrams-lib.git"
...
RDEPEND=">=dev-haskell/active-0.1:=[profile?]
		<dev-haskell/active-0.2:=[profile?]
		...
		<dev-haskell/newtype-0.3:=[profile?]
		>=dev-haskell/fingertree-0.1:=[profile?]
		<dev-haskell/fingertree-0.2:=[profile?]
		>=dev-haskell/intervals-0.2.2:=[profile?]
		<dev-haskell/intervals-0.3:=[profile?]
		>=dev-haskell/numinstances-1.2:=[profile?]
		...
		>=dev-haskell/vector-space-points-0.1.2:=[profile?]
