...
RDEPEND=">=dev-haskell/attoparsec-0.8.0.2[profile?]
		<dev-haskell/attoparsec-0.9[profile?]
		>=dev-haskell/attoparsec-enumerator-0.2.0.3[profile?]
		>=dev-haskell/blaze-builder-0.2.1.4[profile?]
		<dev-haskell/blaze-builder-0.3[profile?]
		>=dev-haskell/bytestring-mmap-0.2.1[profile?]
		...
		>=dev-haskell/enumerator-0.4.5[profile?]
