...
inherit haskell-cabal bash-completion-r1 darcs
...
# Let's just rely on the static version we have installed already...
...
src_prepare() {
	...
	# Conflicts with darcsden
	# darcs unpull --all -p 'remove now useless nesting'
}
