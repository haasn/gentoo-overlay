...
EGIT_REPO_URI="git://github.com/haasn/xmobar.git"
...
#src_prepare() {
	# pull in multi-font support
	# use xft && git pull git://github.com/csstaub/xmobar.git

	# epatch "${FILESDIR}"/${PN}-0.16-ghc-7.6.patch
#}
