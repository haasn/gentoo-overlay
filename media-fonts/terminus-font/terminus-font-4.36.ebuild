...
IUSE="a-like-o centered-tilde distinct-l ru-dv +ru-g quote ru-i ru-k +psf raw-font-data +pcf"
...
src_prepare() {
	...
	# My own patches for tilde's location
	use centered-tilde && epatch "${FILESDIR}"/ctilde.diff
}
